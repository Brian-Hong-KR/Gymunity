    ...
    <SoftBox py={3}>
        <SoftBox mb={3}>
            <SoftBox display="flex" justifyContent="space-between" alignItems="center" p={3}>
                ...
                <SoftTypography variant="body2" color="text"> Nickname@gmail.com</SoftTypography>
            </SoftBox>
            <SoftBox display="flex" justifyContent="space-between" alignItems="center" p={3}>
                <Link to='/modifyUser'>
        ...
        <SoftBox display="flex" justifyContent="space-between" alignItems="center" p={3}>
            <Link to='/customService'>
              ...
              <SoftButton type='submit' variant='gradient' color='white' onClick={handleDeleteAccount}>
              회원탈퇴
              </SoftButton>
          </SoftBox>
      </SoftBox>
