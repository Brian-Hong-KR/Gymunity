...
import com.company.shop.security.jwt.JwtTokenFilter;
//[1] POSTMAN에서 테스트
...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.addFilterBefore(new JwtTokenFilter(membersServiceImp), UsernamePasswordAuthenticationFilter.class);
