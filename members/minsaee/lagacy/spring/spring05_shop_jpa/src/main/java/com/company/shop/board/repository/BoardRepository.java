...
public interface BoardRepository extends JpaRepository<BoardEntity, Long>{
	...
	@Query(value="SELECT b.* FROM board2 b"			     
	...
	@Query(value="SELECT b.*, m.member_name"
			+ " FROM board2 b LEFT JOIN members2 m"			
			+ " ON b.member_email=m.member_email"
		     + " WHERE b.num=:num", nativeQuery=true)
	...
	@Query(value="INSERT INTO board2"
			...
			+ " upload, member_email)"
			+ " VALUES (:#{#entity.subject}, NOW(), 0, :#{#entity.ref},"
			+ " :#{#entity.re_step}, :#{#entity.re_level}, :#{#entity.content},"
			+ " :#{#entity.ip}, :#{#entity.upload}, :memberEmail)", nativeQuery = true)
